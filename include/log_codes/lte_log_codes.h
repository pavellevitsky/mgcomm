...
$Header: //Commercial/MPSS.DPM.2.0.r10/Main/modem_proc/lte/api/lte_log_codes.h#1 $
...
#define LOG_LTE_ML1_SRCH_INTRA_MEAS_CFG_LOG_C       (0x18 + LOG_LTE_ML1_BASE_C)
...
/*! @brief LTE ML1 Coex dsda conflict check msg log code*/
#define LOG_LTE_ML1_COEX_DSDA_PRIO_SWITCH_LOG_C     (0x69 + LOG_LTE_ML1_BASE_C)
