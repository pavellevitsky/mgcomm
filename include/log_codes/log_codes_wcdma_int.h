...
$Header: //Commercial/MPSS.DPM.2.0.r10/Main/modem_proc/wcdma/api/log_codes_wcdma_int.h#1 $
$DateTime: 2014/11/06 03:36:34 $
$Author: mplp4svc $
   
when       who     what, where, why
--------   ---     ----------------------------------------------------------
06/06/14   ymu     Enhancement of the log packet 0x4307 to 0x435D
04/21/14   vn      Added log:0x41BC to accomodate Narrow Band Rejection results.
04/02/14   dp      Add support for tgpsi activity logging
...
#define WCDMA_UL_RLC_TM_LOG_PACKET                       (LOG_WCDMA_BASE_C + 0x11A)   
#define WCDMA_UL_RLC_UM_LOG_PACKET                       (LOG_WCDMA_BASE_C + 0x11B)   
#define WCDMA_DL_RLC_STATE_LOG_PACKET                    (LOG_WCDMA_BASE_C + 0x11F)   
#define WCDMA_DL_RLC_TM_LOG_PACKET                       (LOG_WCDMA_BASE_C + 0x120) 
#define WCDMA_DL_RLC_UM_LOG_PACKET                       (LOG_WCDMA_BASE_C + 0x121)  
#define WCDMA_DL_RLC_V1_AM_LOG_PACKET                    (LOG_WCDMA_BASE_C + 0x132)   
#define WCDMA_UL_RLC_V1_AM_LOG_PACKET                    (LOG_WCDMA_BASE_C + 0x133)
...
#define WCDMA_MAC_HS_UL_CONFIG_LOG_PACKET                (LOG_WCDMA_BASE_C + 0x321)
