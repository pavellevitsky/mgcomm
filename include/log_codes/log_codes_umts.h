...
$Header: //Commercial/MPSS.DPM.2.0.r10/Main/modem_proc/geran/api/public/log_codes_umts.h#1 $
...
#define LOG_UMTS_LAST_C                             (LOG_UMTS_DS_NAS_HPLMN_SEARCH_END_LOG_PACKET_C)
