...
#define MSG_4(xx_ss_id, xx_ss_mask, xx_fmt, xx_arg1, xx_arg2, xx_arg3, \
  ...
  do { \
    ...
    /*lint +e506 +e774*/ \
      XX_MSG_CONST (xx_ss_id, xx_ss_mask, xx_fmt); \
      /*lint -e571 */ \
      msg_send_var (&xx_msg_const, (uint32)(4), (uint32)(uintptr_t)(xx_arg1), \
               (uint32)(uintptr_t) (xx_arg2), (uint32)(uintptr_t) (xx_arg3), \
               (uint32)(uintptr_t) (xx_arg4)); \
      /*lint +e571 */ \
    } \
  /*lint -e717 */ \
  } while (0) \
...
#define MSG_5(xx_ss_id, xx_ss_mask, xx_fmt, xx_arg1, xx_arg2, xx_arg3, \
  ...
  do { \
    ...
    /*lint +e506 +e774*/ \
      XX_MSG_CONST (xx_ss_id, xx_ss_mask, xx_fmt); \
      /*lint -e571 */ \
      msg_send_var(&xx_msg_const, (uint32)(5), (uint32)(uintptr_t)(xx_arg1), \
               (uint32)(uintptr_t)(xx_arg2), (uint32)(uintptr_t)(xx_arg3), \
               (uint32)(uintptr_t)(xx_arg4), (uint32)(uintptr_t)(xx_arg5)); \
      /*lint +e571 */ \
    } \
  /*lint -e717 */ \
  } while (0) \
...
#define MSG_6(xx_ss_id, xx_ss_mask, xx_fmt, xx_arg1, xx_arg2, xx_arg3, \
  ...
  do { \
    ...
    /*lint +e506 +e774*/ \
      XX_MSG_CONST (xx_ss_id, xx_ss_mask, xx_fmt); \
      /*lint -e571 */ \
      msg_send_var (&xx_msg_const, (uint32)(6), (uint32)(uintptr_t)(xx_arg1), \
                (uint32)(uintptr_t)(xx_arg2), (uint32)(uintptr_t)(xx_arg3), \
                (uint32)(uintptr_t)(xx_arg4), (uint32)(uintptr_t)(xx_arg5), \
                (uint32)(uintptr_t)(xx_arg6)); \
      /*lint +e571 */ \
    } \
  /*lint -e717 */ \
  } while (0) \
...
#define MSG_7(xx_ss_id, xx_ss_mask, xx_fmt, xx_arg1, xx_arg2, xx_arg3, \
  ...
  do { \
    ...
    /*lint +e506 +e774*/ \
      XX_MSG_CONST (xx_ss_id, xx_ss_mask, xx_fmt); \
      /*lint -e571 */ \
      msg_send_var (&xx_msg_const, (uint32)(7), (uint32)(uintptr_t)(xx_arg1), \
                (uint32)(uintptr_t)(xx_arg2), (uint32)(uintptr_t)(xx_arg3), \
                (uint32)(uintptr_t)(xx_arg4), (uint32)(uintptr_t)(xx_arg5), \
                (uint32)(uintptr_t)(xx_arg6), (uint32)(uintptr_t)(xx_arg7)); \
      /*lint +e571 */ \
    } \
  /*lint -e717 */ \
  } while (0)                                                             \
...
#define MSG_8(xx_ss_id, xx_ss_mask, xx_fmt, xx_arg1, xx_arg2, xx_arg3, \
  ...
  do { \
    ...
    /*lint +e506 +e774*/ \
      XX_MSG_CONST (xx_ss_id, xx_ss_mask, xx_fmt); \
      /*lint -e571 */ \
      msg_send_var (&xx_msg_const, (uint32)(8), (uint32)(uintptr_t)(xx_arg1), \
                (uint32)(uintptr_t)(xx_arg2), (uint32)(uintptr_t)(xx_arg3), \
                (uint32)(uintptr_t)(xx_arg4), (uint32)(uintptr_t)(xx_arg5), \
                (uint32)(uintptr_t)(xx_arg6), (uint32)(uintptr_t)(xx_arg7), \
                (uint32)(uintptr_t)(xx_arg8)); \
      /*lint +e571 */ \
    } \
  /*lint -e717 */ \
  } while (0) \
...
#define MSG_9(xx_ss_id, xx_ss_mask, xx_fmt, xx_arg1, xx_arg2, xx_arg3, \
  ...
  do { \
    ...
    /*lint +e506 +e774*/ \
      XX_MSG_CONST (xx_ss_id, xx_ss_mask, xx_fmt); \
      /*lint -e571 */ \
      msg_send_var (&xx_msg_const, (uint32)(9), (uint32)(uintptr_t)(xx_arg1), \
               (uint32)(uintptr_t)(xx_arg2),  (uint32)(uintptr_t)(xx_arg3), \
	       (uint32)(uintptr_t)(xx_arg4), (uint32)(uintptr_t)(xx_arg5), \
	       (uint32)(uintptr_t)(xx_arg6), (uint32)(uintptr_t)(xx_arg7), \
	       (uint32)(uintptr_t)(xx_arg8), (uint32)(uintptr_t)(xx_arg9)); \
      /*lint +e571 */ \
    } \
  /*lint -e717 */ \
  } while (0) \
...
#define MSG_SPRINTF_1(xx_ss_id, xx_ss_mask, xx_fmt, xx_arg1) \
  do { \
    ...
    /*lint +e506 +e774*/ \
      XX_MSG_CONST (xx_ss_id, xx_ss_mask, xx_fmt); \
      /*lint -e571 */ \
      msg_sprintf (&xx_msg_const,  (uint32)(uintptr_t)(xx_arg1)); \
      /*lint +e571 */ \
    } \
  /*lint -e717 */ \
  } while (0) \
