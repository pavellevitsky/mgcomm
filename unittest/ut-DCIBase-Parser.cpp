/// Unittest for DCIBase and Parser classes working in conjunction
...
*/
    ...
    log_callback_t callback = std::bind(
            &Parser::process_log, std::ref(parser), _1, _2);
    // Add a log handler
    ...
    const char *packets[] = 
    {
        ...
        "cd\x2F\x5B datdc asfd safasdf asdf aa 9",
