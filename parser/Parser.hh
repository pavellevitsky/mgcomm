...
class Parser: public ParserBase
{
    ...
    private:
        ...
        {
            {LOG_GSM_RR_SIGNALING_MESSAGE_C,        {LOG_GSM_RR_SIGNALING_MESSAGE_C,        "GSM SIGNALLING MESSAGE",      &Parser::dec_gsm_signalling}},
            {LOG_GSM_RR_SIGNALING_MESSAGE_C + DSDS, {LOG_GSM_RR_SIGNALING_MESSAGE_C + DSDS, "GSM SIGNALLING MESSAGE DSDS", &Parser::dec_gsm_signalling}},
            {LOG_GSM_POWER_SCAN_C,                  {LOG_GSM_POWER_SCAN_C,                  "GSM POWER SCAN",              &Parser::dec_gsm_powerscan}},
            {LOG_GSM_POWER_SCAN_C + DSDS,           {LOG_GSM_POWER_SCAN_C + DSDS,           "GSM POWER SCAN DSDS",         &Parser::dec_gsm_powerscan}},
        };
